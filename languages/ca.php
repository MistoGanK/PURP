...
return [
    ...
    'category_subinspector' => 'inspector adjunt',
    ...
    'mfa_setup_subtitle'    => 'Escanegeu el codi QR amb la vostra aplicació d\'autenticació (Aegis, Google Authenticator) para vincular la vostra credencial policial.',
